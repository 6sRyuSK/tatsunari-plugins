...
//
// A small, modern dark LookAndFeel shared by this plugin's editor. Warm amber
// accent to suit a saturation effect. Header-only.
//
...
public:
    ...
    static juce::Colour accent()     { return juce::Colour (0xffe6913c); } // amber
    static juce::Colour accentDim()  { return juce::Colour (0xff8a5a2a); }
